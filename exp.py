...
for test_size, dev_size in test_dev_combs:
    ...
    utils.tune_params(digits.images, digits.target, test_size, dev_size, h_param_combs['svm'], shuffle=True)
    utils.tune_params(digits.images, digits.target, test_size, dev_size, h_param_combs['tree'], 
